...
from post_processing import post_processing, overview
...
def index():
    ...
    return render_template('index.html', dataframe_thorax=df_stats_thorax, dataframe_abdomen=df_stats_abdomen, dataframe_info=info_df,
                           image_path_thorax=image_path_thorax, image_path_abdomen=image_path_abdomen, image_path_overview=image_path_overview)
